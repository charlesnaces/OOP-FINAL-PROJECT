...
class JSONLoader:
    ...
    def load(self):
        ...
        Raises:
            ...
            InvalidJSONError: If the file is not a valid JSON or not a list of objects.
        """
        try:
            ...
            raise InvalidJSONError(f"Error: Failed to decode JSON from '{self.filepath}'. Check file for syntax errors.") from e

        if not isinstance(data, list):
            raise InvalidJSONError(f"JSON root in '{self.filepath}' must be a list of objects.")
